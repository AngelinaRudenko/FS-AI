...
For this project, I chose to use Random Forest Regression as the main prediction algorithm. Random Forest is a type of ensemble method that builds many decision trees and combines their predictions. This choice is justified by several reasons.
